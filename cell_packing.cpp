...
// (1) inner core of cherry represents physical cell boundary, which is impentrable
// (2) outer shell of cherry represents soft-repulsive long-range interaction between same specices
...
//      (2) quence system considering interaction between the outer shell
