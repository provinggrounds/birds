...
(define-param LengthUCX (sqrt 584))
(define-param LengthUCY (sqrt 584))
...
(define dielBack (make dielectric (epsilon epsBack)))      ;; make the background dielectric
(define dielCylH (make dielectric (epsilon epsCylH)))       ;;make the foreground dielectric

;;; Fill the space with background dielectric

(set! default-material  dielBack)

(set-param! CylinderHorizontalRadius 0.04) ;;radius of cylinder , thickness = 2 * CylinderHorizontalRadius

(include "twospecies46_TE_define.ctl" )

(include "twospecies46_TE_make.ctl" )              
...
;;(define fname (string-append "_twospecies46_MHUDS"))
