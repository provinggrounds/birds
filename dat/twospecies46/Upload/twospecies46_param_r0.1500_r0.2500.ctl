...
(define-param LengthUCX (sqrt 300))
(define-param LengthUCY (sqrt 300))
...
(include "twospecies46_define_r0.1500_r0.2500.ctl" )

(include "twospecies46_make.ctl")
...
;;(define fname (string-append "_twospecies46_MHUDS_r0.1500_r0.2500"))
