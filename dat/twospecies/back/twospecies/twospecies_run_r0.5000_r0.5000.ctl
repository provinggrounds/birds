#!/bin/bash
# parallel job using 48 processors.  Runs for 6 hours (max).
#PBS -l nodes=4:ppn=12,walltime=6:00:00
#PBS -m abe
...
twospecies_param_r0.5000_r0.5000.ctl > ./out/twospecies_out_r0.5000_r0.5000.OUT ; 
