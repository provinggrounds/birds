...
(define-param LengthUCX (sqrt 181))
(define-param LengthUCY (sqrt 181))
...
(include "twospecies100_define_r0.1000_r0.3000.ctl" )

(include "twospecies100_make.ctl")
...
(define fname (string-append "_twospecies100_MHUDS_r0.1000_r0.3000"))
